...
Programação, arquitetura de software, devops, decisões técnicas. Stack principal: Python/Django (backend), JavaScript/React + Mantine (frontend), às vezes TypeScript.

## Subpastas

- [[concepts/]] — conceitos atemporais (idempotência, CQRS, event sourcing...)
- [[entities/]] — tecnologias e ferramentas (Django, Mantine, PostgreSQL...)
- [[sources/]] — artigos, vídeos, livros técnicos digeridos
- [[notes/]] — decisões pessoais, snippets, learnings práticos
